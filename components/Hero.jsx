    ...
    <div className="flex w-1/2 md:fixed">
      ...
      <div className="left my-[10vh] md:my-[20vh] mx-12 md:mx-20">
        ...
        <div className="socials flex text-3xl space-x-9">
          <a target={"_blank"} href={"https://twitter.com/Rounak_28"}>
          <AiOutlineTwitter />
          </a>
          <a target={"_blank"} href={"https://github.com/Rounak-28"}>
          <AiFillGithub />
          </a>
          <a target={"_blank"} href={"https://www.linkedin.com/in/rounak-kumbhakar-6110a0233"}>
          <AiFillLinkedin />
          </a>
        </div>
      </div>
